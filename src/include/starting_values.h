...
const uint64_t white_pawns = -1;
const uint64_t black_pawns = 1;

const uint64_t white_knights = -1;
const uint64_t black_knights = 1;

const uint64_t white_bishops = -1;
const uint64_t black_bishops = 1;

const uint64_t white_rooks = -1;
const uint64_t black_rooks = 1;

const uint64_t white_queen = -1;
const uint64_t black_queen = 1;

const uint64_t white_king = -1;
